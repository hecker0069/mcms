...
# ============================================
# Minecraft Paper Server Setup for Termux
# Mobile Ubuntu/Arch64 (aarch64)
...
print_banner() {
    ...
    echo -e "${CYAN}"
    echo "╔════════════════════════════════════════════╗"
    echo "║   Minecraft Paper Server for Termux        ║"
    echo "║   Mobile Setup (aarch64)                   ║"
    echo "╚════════════════════════════════════════════╝"
    echo -e "${NC}"
}
...
install_dependencies() {
    ...
    pkg install -y openjdk-17 wget curl jq screen
